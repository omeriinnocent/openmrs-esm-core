...
Defined in: [packages/framework/esm-react-utils/src/useLeftNav.ts:26](https://github.com/omeriinnocent/openmrs-esm-core/blob/main/packages/framework/esm-react-utils/src/useLeftNav.ts#L26)
