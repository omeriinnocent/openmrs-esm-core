...
Defined in: [packages/framework/esm-extensions/src/left-nav.ts:49](https://github.com/omeriinnocent/openmrs-esm-core/blob/main/packages/framework/esm-extensions/src/left-nav.ts#L49)
