...
Defined in: [packages/framework/esm-emr-api/src/visit-utils.ts:180](https://github.com/omeriinnocent/openmrs-esm-core/blob/main/packages/framework/esm-emr-api/src/visit-utils.ts#L180)
