...
Defined in: [packages/framework/esm-api/src/openmrs-fetch.ts:112](https://github.com/omeriinnocent/openmrs-esm-core/blob/main/packages/framework/esm-api/src/openmrs-fetch.ts#L112)
