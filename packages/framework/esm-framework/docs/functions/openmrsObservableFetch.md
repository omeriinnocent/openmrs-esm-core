...
Defined in: [packages/framework/esm-api/src/openmrs-fetch.ts:306](https://github.com/omeriinnocent/openmrs-esm-core/blob/main/packages/framework/esm-api/src/openmrs-fetch.ts#L306)
