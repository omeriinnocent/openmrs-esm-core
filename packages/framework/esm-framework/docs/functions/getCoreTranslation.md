...
Defined in: [packages/framework/esm-translations/src/index.ts:69](https://github.com/omeriinnocent/openmrs-esm-core/blob/main/packages/framework/esm-translations/src/index.ts#L69)
