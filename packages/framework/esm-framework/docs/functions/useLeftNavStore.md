...
Defined in: [packages/framework/esm-react-utils/src/useLeftNavStore.ts:20](https://github.com/omeriinnocent/openmrs-esm-core/blob/main/packages/framework/esm-react-utils/src/useLeftNavStore.ts#L20)
