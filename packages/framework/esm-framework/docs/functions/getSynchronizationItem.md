...
Defined in: [packages/framework/esm-offline/src/sync.ts:311](https://github.com/omeriinnocent/openmrs-esm-core/blob/main/packages/framework/esm-offline/src/sync.ts#L311)
