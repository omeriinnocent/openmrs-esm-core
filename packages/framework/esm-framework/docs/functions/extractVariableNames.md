...
Defined in: [packages/framework/esm-expression-evaluator/src/extractor.ts:47](https://github.com/omeriinnocent/openmrs-esm-core/blob/main/packages/framework/esm-expression-evaluator/src/extractor.ts#L47)
