...
Defined in: [packages/framework/esm-state/src/state.ts:97](https://github.com/omeriinnocent/openmrs-esm-core/blob/main/packages/framework/esm-state/src/state.ts#L97)
