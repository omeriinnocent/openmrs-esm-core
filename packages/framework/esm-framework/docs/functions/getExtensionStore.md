...
Defined in: [packages/framework/esm-extensions/src/store.ts:131](https://github.com/omeriinnocent/openmrs-esm-core/blob/main/packages/framework/esm-extensions/src/store.ts#L131)
