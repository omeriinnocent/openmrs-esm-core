...
Defined in: [packages/framework/esm-api/src/current-user.ts:123](https://github.com/omeriinnocent/openmrs-esm-core/blob/main/packages/framework/esm-api/src/current-user.ts#L123)
