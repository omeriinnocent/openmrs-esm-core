...
Defined in: [packages/framework/esm-react-utils/src/useAttachments.ts:32](https://github.com/omeriinnocent/openmrs-esm-core/blob/main/packages/framework/esm-react-utils/src/useAttachments.ts#L32)
