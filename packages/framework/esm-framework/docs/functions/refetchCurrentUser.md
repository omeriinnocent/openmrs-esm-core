...
Defined in: [packages/framework/esm-api/src/current-user.ts:204](https://github.com/omeriinnocent/openmrs-esm-core/blob/main/packages/framework/esm-api/src/current-user.ts#L204)
