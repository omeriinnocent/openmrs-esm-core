...
Defined in: [packages/framework/esm-api/src/current-user.ts:230](https://github.com/omeriinnocent/openmrs-esm-core/blob/main/packages/framework/esm-api/src/current-user.ts#L230)
